<template>
    <div class="">
      ...
      <el-menu class="el-menu-vertical-demo" v-for="( item1 ,index1 ) in menuList" @open="handleOpen" @close="handleClose" :collapse="isCollapse">
          ...
          <template  v-for="( item2 ,index2 ) in item1.childList">
            <el-submenu index="">
              ...
              <template v-for="( item3 ,index3 ) in item2.childList">
                <el-menu-item index="">{{ item3.name }}</el-menu-item>
              </template>
